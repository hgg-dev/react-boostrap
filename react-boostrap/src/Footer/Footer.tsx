      ...
      <div className={"footer"}>
        <div className={"footer-left"}>
          <p className={"footerText"}>
            © Wonder Bank™ 2020 | All Rights Reserved | Judo Bank Pty Ltd | ABN
            11 615 995 571 | ACL and AFSL 501 021 | This information is of a
            ...
            conditions may apply to Judo Bank’s products and services
          </p>
        </div>
